...
Na het uitlijnen zijn de gemapte reads per gen geteld met featureCounts, er is een kwaliteitscontrole uitgevoerd op de ruwe matrix en ruis is verwijderd.
...
De [GO verrijkte processen (csv)](Results/GO_significante_resultaten.csv) liet sterke verrijking zien van processen die kenmerkend zijn voor RA. Belangrijke processen zoals cytokine-gemedieerde signaalroutes, immuunrespons weerspiegelen de centrale rol van cytokinen zoals IL-6 en TNF-alpha in de onstekingscascade van RA (Zhang et al., 2023).
